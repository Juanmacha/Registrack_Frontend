...
const NavBar = () => {
  ...
  return (
    <div className="w-full bg-white flex justify-between items-center px-6 py-3 hover:shadow-2xl transition-shadow duration-300 z-40">
      ...
      <h1 className="text-xl font-semibold text-gray-700">Solicitudes</h1>

      {/* Icono de perfil como botón */}
      <div className="relative">
        <button
          onClick={toggleMenu}
          className="bg-gray-200 focus:outline-none rounded-full hover:bg-gray-300 p-2 transition duration-200 focus:outline-none"
        >
